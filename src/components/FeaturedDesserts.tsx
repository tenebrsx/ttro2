                ...
                <div className="text-center">
                  ...
                  <div className="flex justify-center space-x-4">
                    <button
                      ...
                      className="inline-flex items-center gap-2 bg-gradient-to-r from-sage-500 to-sage-600 hover:from-sage-600 hover:to-sage-700 text-white px-6 py-3 rounded-2xl font-bodoni font-medium shadow-warm hover:shadow-glow transition-all duration-500 tracking-button-refined"
                    >
                      <span>Recargar</span>
                    </button>
                    <Link
                      to="/contact"
                      className="inline-flex items-center gap-2 bg-white text-sage-600 border-2 border-sage-600 hover:bg-sage-50 px-6 py-3 rounded-2xl font-bodoni font-medium transition-all duration-500 tracking-button-refined"
                    >
