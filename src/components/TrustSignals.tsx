            ...
            return (
              ...
              >
                <div className="relative mb-6">
                  <div className="w-20 h-20 bg-gradient-to-br from-dusty-rose/10 to-warm-blush/10 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-105 transition-transform duration-300">
                    <IconComponent className="w-10 h-10 text-dusty-rose" />
                  </div>
                  <div className="absolute -top-2 -right-2 bg-dusty-rose text-white text-xs px-2 py-1 rounded-full font-karla font-medium">
                    {element.highlight}
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {certifications.map((cert, index) => (
              ...
              >
                ...
                <span className="text-mocha/80 font-karla text-sm">{cert}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
