              ...
              <FadeInUp>
                <div className="text-center mb-16">
                  ...
                  <p className="text-lg body-elegant leading-relaxed font-source-serif font-light max-w-3xl mx-auto mb-8">
                    🇩🇴 La primera repostería francesa auténtica en República
                    Dominicana. Macarons elaborados con ingredientes importados
                    de Francia, tartas personalizadas con técnicas parisinas y
                    sabores que conquistan el paladar dominicano. Precios en
                    pesos dominicanos, entrega en Santo Domingo y Santiago.
                  </p>
                </div>
              </FadeInUp>
            </div>
